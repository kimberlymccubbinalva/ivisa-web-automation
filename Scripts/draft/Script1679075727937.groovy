...
WebUI.click(findTestObject('Object Repository/Admin Portal/Mailhog/Email Subject - Action Required TD'))

//WebUI.click(findTestObject('Object Repository/Admin Portal/Mailhog/Email - btnText'))

//EmailURL = WebUI.getText(findTestObject('Object Repository/draft - login_link'))

WebUI.click(findTestObject('Object Repository/draft - login_link'))

/*
EmailURL = WebUI.getAttribute(findTestObject('Object Repository/draft - login_link'), 'href')
