...
WebUI.selectOptionByValue(findTestObject('Admin Portal/Issue Refund/Refund Form - Refund Reason'), 'cannot_finish', false)
...
WebUI.check(findTestObject('Admin Portal/Issue Refund/Refund items Other'))

WebUI.check(findTestObject('Admin Portal/Issue Refund/Refund Other 1'))

WebUI.check(findTestObject('Admin Portal/Issue Refund/Refund Other 2'))
