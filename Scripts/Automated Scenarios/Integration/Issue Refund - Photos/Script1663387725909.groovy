...
WebUI.selectOptionByValue(findTestObject('Admin Portal/Issue Refund/Refund Form - Refund Reason'), 'printing_issues', false)
...
WebUI.check(findTestObject('Admin Portal/Issue Refund/Refund Option 2 (A1)'))
