...
WebUI.setText(findTestObject('Website/Login page/Option 3.1 - User email'), 'individual.subs@paypal.com')
...
//iVisa Plus
WebUI.scrollToElement(findTestObject('Website/General page/Footer'), 1)

WebUI.click(findTestObject('Website/Footer/iVisa Plus'))

WebUI.click(findTestObject('Website/Subscriptions/Button - View plans'))

WebUI.click(findTestObject('Website/Subscriptions/Button - Apply Family'))
...
WebUI.setText(findTestObject('Website/Login page/Option 3.1 - User email'), 'family.subs@paypal.com')
...
WebUI.click(findTestObject('Website/Subscriptions/Button - Apply Individual'))
