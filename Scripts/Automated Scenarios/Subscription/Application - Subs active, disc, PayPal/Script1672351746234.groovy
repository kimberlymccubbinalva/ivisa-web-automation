...
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Application - Change currency'), [('SelectCurrency') : 'USD'], FailureHandling.OPTIONAL)
...
//Step_4
WebUI.click(findTestObject('Website/Application CTAs/Processing - Super Rush Turkey'))
...
//Payment PayPal
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Application - Payment PayPal'), [:], FailureHandling.STOP_ON_FAILURE)
