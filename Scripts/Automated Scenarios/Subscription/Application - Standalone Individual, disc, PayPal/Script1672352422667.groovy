...
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Application - Standalone Subscription'),
	[('FirstName') : 'PayPal',
	('LastName') : 'Payment',
	('Email') : 'individual.subs@paypal.com',
	('CurrencyOption') : 'USD'],
	FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Website/Subscriptions/Subscription - Option Individual'), FailureHandling.OPTIONAL)
