...
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Form - FileUpload question'),
	[('FileUpload') : 'Website/General questions/ID 100 - passport_photo (A1)'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Website/General questions/ID 1 - email'), 'mail4@mail.com')
...
//Step_6
WebUI.click(findTestObject('Website/Application CTAs/Delivery - StorePickUp'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Website/General questions/StorePickUp - PostalCode'), '33160')

WebUI.click(findTestObject('Website/Application CTAs/Button - SearchZipCode'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('Website/General questions/StorePickUp - Store'), 2)

WebUI.click(findTestObject('Website/General questions/StorePickUp - Store'), FailureHandling.STOP_ON_FAILURE)
