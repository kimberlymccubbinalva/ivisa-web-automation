...
//Step_payment - Calling test case 'Payment PayPal'
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Application - Payment PayPal'), [:], FailureHandling.OPTIONAL)
