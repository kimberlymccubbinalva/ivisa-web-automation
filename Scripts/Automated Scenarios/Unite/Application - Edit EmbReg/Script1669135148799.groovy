...
WebUI.setText(findTestObject('Website/General questions/ID 1 - email'), 'mail2@mail.com')
...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Form - Dropdown question'), [('Question') : 'Object Repository/Website/General questions/ID 339 - destination_country.general'
        , ('Option') : 'Egypt'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Form - Dropdown question'), [('Question') : 'Object Repository/Website/General questions/ID 7 - nationality_country (A1)'
        , ('Option') : 'Canada (CA)'], FailureHandling.STOP_ON_FAILURE)
