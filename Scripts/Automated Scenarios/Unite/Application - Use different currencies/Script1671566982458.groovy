...
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Application - Change currency'), [('SelectCurrency') : SelectCurrency], FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Website/General questions/ID 5 - first_name.general'), 'z')

WebUI.setText(findTestObject('Website/General questions/ID 6 - last_name.general'), 'z')
