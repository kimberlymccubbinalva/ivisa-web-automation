...
WebUI.setText(findTestObject('Website/General questions/ID 1 - email'), 'mail3@mail.com')
...
WebUI.setText(findTestObject('Website/General questions/ID 154 - shipping_address.general'), 'My address')
