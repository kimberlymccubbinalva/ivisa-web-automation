...
//Get an order
WebUI.click(findTestObject('Object Repository/Affiliate/Button - Purchase now'))
...
WebUI.click(findTestObject('Object Repository/Website/Header/Menu - Orders'))

WebUI.click(findTestObject('Affiliate/Menu - Resources'))

WebUI.click(findTestObject('Object Repository/Affiliate/Button - Previous orders'))
