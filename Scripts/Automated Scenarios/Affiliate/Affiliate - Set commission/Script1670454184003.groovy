...
WebUI.scrollToElement(findTestObject('Admin Portal/Affiliates/Input - Commission rate'), 1)

WebUI.clearText(findTestObject('Admin Portal/Affiliates/Input - Commission rate'))

WebUI.setText(findTestObject('Object Repository/Admin Portal/Affiliates/Input - Commission rate'), '100')

WebUI.click(findTestObject('Object Repository/Admin Portal/Affiliates/Button - Update affiliate'))
