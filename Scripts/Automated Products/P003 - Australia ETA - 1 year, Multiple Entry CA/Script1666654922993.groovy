...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Visa Widget Interaction'), [('Nationality') : 'Canada - CA'
...
WebUI.setText(findTestObject('Object Repository/Website/General questions/ID 63 - address (A1)'), GlobalVariable.GeneralString)
