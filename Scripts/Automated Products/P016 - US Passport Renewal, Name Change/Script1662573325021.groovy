...
WebUI.click(findTestObject('Website/Passport Renewal/Button - Learn more'))
...
WebUI.selectOptionByValue(findTestObject('Website/General questions/ID 9 - gender.general'), 'Male', false)
