...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Visa Widget Interaction'), [('Nationality') : 'India - IN'
        , ('Destination') : 'Sri Lanka - LK'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Website/General questions/ID 737 - hotel_reservation (A1)'), GlobalVariable.GeneralString)

WebUI.click(findTestObject('Website/General questions/ID 908 - card_holder_disclaimer (A1)'))
...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Form - Dropdown question'), [('Question') : 'Object Repository/Website/General questions/ID 174 - traveling_from.general'
        , ('Option') : 'India - IN'], FailureHandling.STOP_ON_FAILURE)
...
//
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Form - FileUpload question'), [('FileUpload') : 'Object Repository/Website/General questions/ID 618 - card_holder_photo_id (A1)'], 
