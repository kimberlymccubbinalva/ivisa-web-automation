...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Visa Widget Interaction'), [('Nationality') : 'United States - US'
        , ('Destination') : 'Kenya - KE'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Calls for test cases/Website/Form - Dropdown question'), [('Question') : 'Object Repository/Website/General questions/ID 98 - port_of_arrival.general'
        , ('Option') : 'AIR - Eldoret International Airport'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 379 - traveling_with_dependents.general'), 'No', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 101 - traveling_by.general'), 'By Air', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 62 - reason_for_travel.general'), 'Tourism', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 312 - destination_location_type.general'), 'Hotel', true)
...
WebUI.setText(findTestObject('Object Repository/Website/General questions/ID 128 - emergency_contact_name.general'), GlobalVariable.GeneralString)

WebUI.setText(findTestObject('Object Repository/Website/General questions/ID 129 - emergency_contact_phone.general'), GlobalVariable.GeneralString)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 845 - parents_life_status (A1)'), 'Both Deceased', true)
...
//Declarations
WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 569 - refused_entry_to_this_country (A1)'), 'No', true)
...
WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Form - FileUpload question'),
	[('FileUpload') : 'Object Repository/Website/General questions/ID 309 - passport_front_cover (A1)'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Form - FileUpload question'),
	[('FileUpload') : 'Object Repository/Website/General questions/ID 29 - passport_scan (A1)'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/Calls for test cases/Website/Form - FileUpload question'),
	[('FileUpload') : 'Object Repository/Website/General questions/ID 74 - hotel_proof (A1)'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Website/Application CTAs/Button - ContinueUnderForm'))

//Travel
WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 225 - returning_home (A1)'), 'Yes', true)

WebUI.click(findTestObject('Website/Application CTAs/Button - ContinueUnderForm'))

//Past travel
WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 388 - previously_visited (A1)'), 'No', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Website/General questions/ID 330 - travel_other_countries (A1)'), 'No', true)
